...
class CoordinatorServer():
    ...
    def send_broadcast_signal(self):
        '''Envia una señal de broadcast para que los clientes detecten al coordinator'''
        while self.running:
            try:
                broadcast_info = {
    ...
    def start_socket_server(self):
        '''inicia el coordinator de sockets'''
        self.running = True
        ...
        try:
            ...
            self.log_event('SERVER_STOP', 'Coordinator detenido')
        finally:
    ...
    # def command_interface(self):
        ...
        #                 self.log_event('SERVER_STOP', 'Coordinator detenido')
        #             except Exception as e:
        #                 print(f"Error al cerrar el coordinator: {e}")
...
if __name__ == "__main__":
    ...
    server = CoordinatorServer(host=host, port=port, broadcast_port=broadcast_port)
